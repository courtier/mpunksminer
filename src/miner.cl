/* https://github.com/johguse/profanity/blob/master/keccak.cl
...
#define THETA(s00, s01, s02, s03, s04, s10, s11, s12, s13, s14, s20, s21, s22, \
              s23, s24, s30, s31, s32, s33, s34, s40, s41, s42, s43, s44)      \
  {                                                                            \
...
#define RHOPI(s00, s01, s02, s03, s04, s10, s11, s12, s13, s14, s20, s21, s22, \
              s23, s24, s30, s31, s32, s33, s34, s40, s41, s42, s43, s44)      \
  {                                                                            \
...
#define KHI(s00, s01, s02, s03, s04, s10, s11, s12, s13, s14, s20, s21, s22,   \
            s23, s24, s30, s31, s32, s33, s34, s40, s41, s42, s43, s44)        \
  {                                                                            \
    t0 = s00 ^ (~s10 & s20);                                                   \
    t1 = s10 ^ (~s20 & s30);                                                   \
...
kernel void miner_init(const char *bytes_prefix, const ulong range_start,
  ...
  for (i = 0; i < 16; i++) {
    ...
    printf(BYTE_TO_BINARY_PATTERN "" BYTE_TO_BINARY_PATTERN,
           BYTE_TO_BINARY(h.d[i] >> 8), BYTE_TO_BINARY(h.d[i]));
  }
  printf("\n");
